<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE banner SET imagem = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/banner/".$targetFile);
        Thumbnail( "../img/banner/".$targetFile, "../img/banner/".$targetFile , $w, $h);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
