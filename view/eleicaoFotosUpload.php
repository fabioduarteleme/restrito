<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE eleicao SET imagem = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/eleicao/".$targetFile);
        Thumbnail( "../img/eleicao/".$targetFile, "../img/eleicao/".$targetFile , $w, $h);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
