...
$pagebtn ="Evento";
$tabelabd ="eventos";
$controller = "../controller/eventosController.php";
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- UPLOAD START -->
                        <hr>
                        <form id="upload" method="post" action="../view/eventosFotosUpload.php?upload=<?php echo $_GET['upload']; ?>&iduser=<?php echo $_GET['iduser']; ?>&tipo=<?php echo $tabelabd; ?>&w=<?php echo $largura; ?>&h=<?php echo $altura; ?>" enctype="multipart/form-data">
                            <div id="drop">
                        ...
                        <script type="text/javascript">
                            ...
                            cache: false,
                            url:"eventosFotos.php?iduser=<?php echo $_GET['iduser']; ?>&upload=<?php echo $_GET['upload']; ?>",
                            beforeSend:function(){
                                $(".carregando").show()
                            },
                            complete:function(){
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="tipo">
                                                <option value="show" <?php if (!(strcmp("show", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Show</option>
                                                <option value="evento" <?php if (!(strcmp("evento", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Evento</option>
                                            </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input placeholder="Data" name="data" type="text" class="form-control date" value="<?php echo htmlentities($row_up['data'], ENT_COMPAT, 'utf-8'); ?>" required/>
                                            </div> 

                                            <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            <input placeholder="Horário" name="horario" type="text" class="form-control time" value="<?php echo htmlentities($row_up['horario'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div>

                                            <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                                <select class="form-control col-md-12" name="diadasemana" require>
                                                    <option value="Segunda" <?php if (!(strcmp("Segunda", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Segunda</option>
                                                    <option value="Terça" <?php if (!(strcmp("Terça", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Terça</option>
                                                    <option value="Quarta" <?php if (!(strcmp("Quarta", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Quarta</option>
                                                    <option value="Quinta" <?php if (!(strcmp("Quinta", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Quinta</option>
                                                    <option value="Sexta" <?php if (!(strcmp("Sexta", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Sexta</option>
                                                    <option value="Sábado" <?php if (!(strcmp("Sábado", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Sábado</option>
                                                    <option value="Domingo" <?php if (!(strcmp("Domingo", htmlentities($row_up['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> Domingo</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input placeholder="Local" name="local" type="text" class="form-control" value="<?php echo htmlentities($row_up['local'], ENT_COMPAT, 'utf-8'); ?>" />
                                            </div> 
                                        ...
                                        <div class="row">
                                            ...
                                            <input placeholder="Valor 01" name="valor1" type="text" class="form-control money" value="<?php echo htmlentities($row_up['valor1'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div> 

                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="Valor 02" name="valor2" type="text" class="form-control money" value="<?php echo htmlentities($row_up['valor2'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div> 
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="URL 01" name="url1" type="text" class="form-control" value="<?php echo htmlentities($row_up['url1'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div> 

                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="URL 02" name="url2" type="text" class="form-control" value="<?php echo htmlentities($row_up['url2'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div> 
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-12">
                                            <input placeholder="Informações" name="informacao" type="text" class="form-control" value="<?php echo htmlentities($row_up['informacao'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                            <input placeholder="Código embed do mapa" name="mapa" type="text" class="form-control" value="<?php echo htmlentities($row_up['mapa'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="text-center"><img width="400" src="../img/eventos/<?php echo $row_up['imagem']; ?>"><br><br><a href="eventos.php?upload=<?php echo base64_encode($row_r['id']); ?>&iduser=<?php echo base64_encode($row_user["idusuario"]); ?>"><div class="btn btn-default btn-lg"><i class="fa fa-upload"></i> Altere esta imagem</div></a><br><br></div>
                                                <?php } else { ?>
                                                <div class="text-center"><a href="eventos.php?upload=<?php echo base64_encode($row_r['id']); ?>&iduser=<?php echo base64_encode($row_user["idusuario"]); ?>"><div class="btn btn-default btn-lg"><i class="fa fa-upload"></i> Enviar uma imagem</div></a><br><br></div>
                                                <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" name="dataCadastro" value="<?php echo htmlentities($row_up['data_cadastro'], ENT_COMPAT, 'utf-8'); ?>" />
                            ...
                            <div class="modal-dialog">
                                ...
                                <form role="form" action="<?php echo $controller; ?>" method="post" data-toggle="validator" name="addForm" class="form-group" id="addForm">
                            		<div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            <input placeholder="Data" name="data" type="text" class="form-control date" value="" required/>
                                            </div> 

                                            <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            <input placeholder="Horário" name="horario" type="text" class="form-control time" value=""/>
                                            </div>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                            <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                            <input placeholder="Local" name="local" type="text" class="form-control" value="" />
                                            </div> 

                                            <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                            <select class="form-control" id="estado" value="PR"></select>
                                            </div> 

                                            <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                            <select class="form-control" id="cidade" value="Maringá"></select>
                                            </div> 
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="Valor 01" name="valor1" type="text" class="form-control money" value=""/>
                                            </div> 

                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="Valor 02" name="valor2" type="text" class="form-control money" value=""/>
                                            </div> 
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="URL 01" name="url1" type="text" class="form-control" value=""/>
                                            </div> 

                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <input placeholder="URL 02" name="url2" type="text" class="form-control" value=""/>
                                            </div> 
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-12">
                                            <input placeholder="Informações" name="informacao" type="text" class="form-control" value=""/>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                            <input placeholder="Código embed do mapa" name="mapa" type="text" class="form-control" value=""/>
                                            </div> 
                                        </div>
