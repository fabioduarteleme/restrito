<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE empresa SET imagem = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/empresa/".$targetFile);
        Thumbnail( "../img/empresa/".$targetFile, "../img/empresa/".$targetFile , 1024, 1024);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
