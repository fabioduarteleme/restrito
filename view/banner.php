                                ...
                                <form role="form" action="<?php echo $controller; ?>" method="post" data-toggle="validator" class="form-group" name="editForm" id="editForm">
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <input name="descricao" type="text" class="form-control" value="<?php echo htmlentities($row_up['descricao'], ENT_COMPAT, 'utf-8'); ?>"/>
                                            </div>  
                                            <div class="form-group col-md-6">
                                            <label>Link</label>
                            ...
                            <div class="modal-dialog">
                                ...
                                <form role="form" action="<?php echo $controller; ?>" method="post" data-toggle="validator" name="addForm" class="form-group" id="addForm">
                            		<div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                            <input placeholder="Breve Descrição" name="descricao" type="text" class="form-control" value=""/>
                                            </div> 
