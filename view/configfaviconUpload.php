<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE config SET favicon = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/config/favicon/".$targetFile);
        //Thumbnail( "../img/config/".$targetFile, "../img/config/".$targetFile , 1024, 1024);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
