<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE eventos SET imagem = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/eventos/".$targetFile);
        Thumbnail( "../img/eventos/".$targetFile, "../img/eventos/".$targetFile , $w, $h);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
