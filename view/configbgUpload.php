<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE config SET background = '$targetFile' WHERE id = '$idregistro' ");
        move_uploaded_file($file_tmp,"../img/config/".$targetFile);
        Thumbnail( "../img/config/".$targetFile, "../img/config/".$targetFile , 1500, 1500);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
