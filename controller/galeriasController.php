...
$pagereturn = "../view/galerias.php";
$tabelabd = "galerias";

//INSERT DATA
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addForm")) {
$insertSQL = sprintf("INSERT INTO $tabelabd (dataCadastro, idusuario, ativo, titulo, descricao) VALUES (%s, %s, %s, %s, %s)",
...
$updateSQL = sprintf("UPDATE $tabelabd SET dataCadastro=%s, ativo=%s, titulo=%s, descricao=%s WHERE id=%s",
GetSQLValueString($_POST['dataCadastro'], "date"),
GetSQLValueString($_POST['ativo'], "text"),
GetSQLValueString($_POST['titulo'], "text"),
GetSQLValueString($_POST['descricao'], "text"),
