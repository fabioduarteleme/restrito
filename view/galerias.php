...
$pagebtn ="Galeria";
$tabelabd ="galerias";
$controller = "../controller/galeriasController.php";
                            ...
                            <div class="col-lg-12">
                                ...
                                <form role="form" action="<?php echo $controller; ?>" method="post" data-toggle="validator" class="form-group" name="editForm" id="editForm">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                        <label>Descreva esta galeria</label>
                                        <textarea placeholder="Escreva mais detalhes" name="descricao" type="text" class="form-control"/><?php echo htmlentities($row_up['descricao'], ENT_COMPAT, 'utf-8'); ?></textarea>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" name="dataCadastro" value="<?php echo htmlentities($row_up['dataCadastro'], ENT_COMPAT, 'utf-8'); ?>" />
                            ...
                            <div class="modal-dialog">
                                ...
                                <form role="form" action="<?php echo $controller; ?>" method="post" data-toggle="validator" name="addForm" class="form-group" id="addForm">
                            		<div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                            <textarea placeholder="Escreva mais detalhes" name="descricao" type="text" class="form-control"/></textarea>
                                            </div> 
                                        </div>
                  ...
                  <script type="text/javascript">
                        $(document).ready(function(){
                            $('.btn-ativo').click(function(){
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "../controller/galeriasController.php",
