...
$pagereturn = "../view/carroModelos.php";
$tabelabd = "carro_modelo";

//INSERT DATA
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addForm")) {
$insertSQL = sprintf("INSERT INTO $tabelabd (id, fabricante, tipo, nome) VALUES (%s, %s, %s, %s)",
...
$updateSQL = sprintf("UPDATE $tabelabd SET nome=%s WHERE id=%s",
GetSQLValueString($_POST['nome'], "text"),
