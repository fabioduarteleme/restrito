<?php
    ...
    if(empty($errors)==true){ 
        ...
        $sql = mysql_query("UPDATE usuario SET imagem = '$targetFile' WHERE idusuario = '$idusuario' ");
        move_uploaded_file($file_tmp,"../img/profile/".$targetFile);
        Thumbnail( "../img/profile/".$targetFile, "../img/profile/".$targetFile , 800, 600);
        echo '{"status":"success"}';
        exit;
    }else{
        print_r($errors);
